...
答案见：<https://cug-hydro.github.io/hydroTools/articles/vapour_press.html>
...
> 从大气温度$T$→露点温度$T'$过程中，水汽压从$e →es(T')$。蒸发所需能量全部来源于空气降温。

- (a) 水汽浓度升高（$m_v' > m_v$）；
   潜热的变化：$\lambda (m_v' - m_v)$
...
$$
\begin{align*}
\lambda ( \frac{e_s(T')}{P} \epsilon \rho - \frac{e}{P} \epsilon \rho ) &= - \rho c_p (T'-T) \\
...
2. <span style='background-color:yellow'>小尺度</span>，水汽充足情况下：
   X -> A点

<br>

> 小尺度意味着蒸发不会对周围的气象因素造成影响。
</div>

![bg right:70% 90%](images/感热与潜热比例.png)
...
风羽：包含风向杆、<span style='background-color:yellow'>风矢（短：1~2m/s、长：3~4m/s）</span>、风三角
<br>
...
上式**忽略的因素**：<span style='background-color:yellow'>人类活动的影响</span>
...
- 定义：由分水线所包围的河流集水区。
   ...
   > 分水线：流域四周水流方向不同的界线。在山区是山脊线，在平原则常以堤防或岗地为分水线。
