...
- 位势高度距平偏高：大气层平均虚温$T_v$偏高
   <br>
   2.3. > 因此，通过看位势高度距平，可以得出空间上哪些地区温度偏高（<span style='color:red'><u>热浪</u></span>）、哪些地区温度偏低（<span style='color:blue'><u>寒潮</u></span>）。
---
...
#### 2.4.1.1. 气压梯度力 (pressure gradient force, PGF)
