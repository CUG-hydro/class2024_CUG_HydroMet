...
> **影响太阳辐射的两个主要变量：<span style='color:red; background:yellow'>DOY, hour</span>**

---

## 3.1. 日地距离 & DOY (Day of Year)
...
![h:15cm](images/ch05_辐射与能量平衡/太阳高度角-01.png)  
...
$$
\begin{align*}
Rs_{toa} &= \int_{-w_0}^{w_0}{\frac{dQ_s}{dt}} dt
