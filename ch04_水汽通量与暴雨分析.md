...
![bg right:40% 120%](images/ch04_水汽通量与暴雨分析/连续方程-01.png)  
...
{\partial u \over \partial x} +
  {\partial v \over \partial y} +
  {\partial w \over \partial z} = 0, (w = \frac{dz}{dt})
$$
...
{\partial u \over \partial x} +
  {\partial v \over \partial y} +
  {\partial \omega \over \partial p} = 0, (\omega = \frac{dp}{dt})
$$
...
\begin{align*}
d &= \nabla_h (q \rho v) \\
D &= -\frac{1}{g} \int_{p_s}^{p_t} \nabla_h(q v) d p
\end{align*}
$$

- $D < 0$，进多出少（<u>**降水**</u>），辐合，气柱的<span style='color:blue'>水汽增加+ :</span>

- $D > 0$，进少出多（<u>**蒸发**</u>），辐散，气柱的<span style='color:red'>水汽流失-</span>

> $D$可以类比径流。

---

![](images/ch04_水汽通量与暴雨分析/通量散度-01.png)
